...
def assign_to_east_west(unused_cards):
    ...
    # If there’s any imbalance, correct it
...
def fill_missing_hands(input_csv, output_csv):
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print("Usage: python bb_fill.py input.csv output.csv")
    else:
        fill_missing_hands(sys.argv[1], sys.argv[2])
